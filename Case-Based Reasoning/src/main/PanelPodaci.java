...
public class PanelPodaci extends JPanel{
	...
	public static JPanel podPanel;
	public static JPanel godinePanel;
	...
	public PanelPodaci(){
		...
		podPanel.add(pol);
		podPanel.add(Box.createHorizontalStrut(10));
		...
		Main.polTxt.setBackground(Color.LIGHT_GRAY);
		podPanel.add(Main.polTxt);
		podPanel.add(Box.createHorizontalStrut(50));
